...
merge_data <- read_csv("bathaus/flat files/Synurb and filter data Merge.csv")

# reading chiroptera combine
trait_data <- read_csv("bathaus/COMBINE Datasets/COMBINE_archives/trait_data_reported.csv") %>%
