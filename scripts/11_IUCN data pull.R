...
# complete
table(zoonotic$Complete) # should be all yes
...
zoonotic$icnames <- recode(zoonotic$species,
...
icname_merge <- merge(zoonotic, rdata[c("icnames","category","population_trend")], by = "icnames", all.x = TRUE) # %>%
